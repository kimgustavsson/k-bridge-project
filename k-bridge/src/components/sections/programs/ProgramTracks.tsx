...
export function ProgramTracks() {
  const t = useTranslations("programTracks");
...
function TrackRow({ track }: TrackRowProps) {
  const t = useTranslations("programTracks");
  const tt = useTranslations(`programTracks.tracks.${track.translationKey}`);
  const Icon = track.icon;

  const highlights = tt.raw("highlights") as string[];
